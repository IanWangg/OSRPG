...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default='hopper-expert-v0')
    ...
    setup_logger(os.path.join('CQL_offline_mujoco_runs', str(rnd)), variant=variant, base_log_dir='~/CQL_RUNS')
