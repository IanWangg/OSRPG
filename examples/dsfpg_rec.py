...
from rlkit.torch.networks.custom import AutoEncoderMlp
...
from rlkit.torch.ddpg.dsfpg_rec import DSFPGTrainer_Rec
...
def experiment(variant):
    ...
    qf = LinearMlp(
        input_size=latent_dim, # take s, a, s' as input
        output_size=1, # output the estimated reward r(s, a, s')
    )
...
if __name__ == "__main__":
    ...
    setup_logger('test viskit using dsfpg-rec', variant=variant)
    experiment(variant)
